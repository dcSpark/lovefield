...
goog.require('lf.proc.ResetCacheTask');
 ...
 */
 lf.proc.Database.prototype.resetCache = function() {
  var task = new lf.proc.ResetCacheTask(this.global_);
  var runner = this.global_.getService(lf.service.RUNNER)
  return runner.scheduleTask(task).then(function() {
    return null;
  });
};
